...
import com.newtonfernandes.cursomc.domain.Estado;
import com.newtonfernandes.cursomc.domain.ItemPedido;
import com.newtonfernandes.cursomc.domain.Pagamento;
import com.newtonfernandes.cursomc.domain.PagamentoComBoleto;
import com.newtonfernandes.cursomc.domain.PagamentoComCartao;
import com.newtonfernandes.cursomc.domain.Pedido;
import com.newtonfernandes.cursomc.domain.Produto;
import com.newtonfernandes.cursomc.domain.enums.EstadoPagamento;
...
import com.newtonfernandes.cursomc.repositories.EstadoRepository;
import com.newtonfernandes.cursomc.repositories.ItemPedidoRepository;
import com.newtonfernandes.cursomc.repositories.PagamentoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "newtonfernandesti@gmail.com", "36378912377", TipoCliente.PESSOA_FISICA, bCryptPasswordEncoder.encode("123456"));		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "anacosta@gmail.com", "27354766003", TipoCliente.PESSOA_FISICA, bCryptPasswordEncoder.encode("123456"));
		cli2.getTelefones().addAll(Arrays.asList("93883321", "34252625"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38230834", cli1, c1);
